...
- [Plataforma técnica básica de Block2Trace](#block2trace-core-technical-platform)
...
4. [Las redes blockchain públicas sin permisos](#4-the-public-permissionless-blockchain-networks)
    - 4.1 [El problema de la escalabilidad de las cadenas de bloques con permiso público](#41-the-problem-of-scalability-of-public-permissioned-blockchains)
    - 4.2 [El problema de los Costos de Transacción: Altos y Volátiles](#42-the-problem-of-transaction-costs--high-and-volatile)
    - 4.3 [El problema de la Privacidad](#43-the-problem-of-privacy)
        - 4.3.1 [Confidencialidad de Datos](#431-confidentiality-of-data)
        - 4.3.2 [Privacidad de Actividades Transaccionales](#432-privacy-of-transactional-activity)
5. [LAS REDES BLOCKCHAIN DEL CONSORCIO PRIVADO](#4-the-private-consortium-blockchain-networks)
    - 5.1 [Una "compensación de confianza" diferente](#41-a-different-trust-trade-off)
    - 5.2 [Un modelo de incentivación diferente para los nodos operativos](#42-a-different-incentivisation-model-for-operating-nodes)
    - 5.3 [Un modelo diferente para la ejecución de transacciones](#43-a-different-transaction-execution-model)
6. [BLOCK2TRACE: UNA BLOCKCHAIN CON PERMISO PÚBLICO](#5-block2trace--a-public-permissioned-blockchain-network)
7. [REQUERIMIENTOS GENERALES SOBRE EL SOFTWARE](#6-general-requirements-about-the-software)
    - 7.1 [Basado en OpenSource de amplia aceptación en el mercado](#61-based-on-opensource-of-wide-acceptance-in-the-market)
    - 7.2 [El ecosistema de usuarios del software debe ser lo más amplio posible](#62-the-ecosystem-of-users-of-the-software-should-be-as-wide-as-possible)
    - 7.3 [Block2Trace debe basarse en plataformas multisectoriales y de uso general](#63-block2trace-should-be-based-on-general-purpose-and-multi-industry-platforms)
    - 7.4 [Block2Trace permitirá y facilitará el cumplimiento normativo por parte de los miembros, en particular:](#64-block2trace-will-allow-and-facilitate-regulatory-compliance-by-the-members--in-particular)
8. [ARQUITECTURA DE REFERENCIA DE UNA BLOCKCHAIN](#7-reference-architecture-of-a-blockchain)
    ...
    - 8.2 [Capa de plataforma DLT](#72-dlt-platform-layer)
        ...
        - 8.2.2 [Contratos Inteligentes](#722-smart-contract)
        - 8.2.3 [Ledger](#723-ledger)
        - 8.2.4 [Manejo de Estados](#724-state-management)
        - 8.2.5 [Sistema de Transacciones](#725-transaction-system)
        - 8.2.6 [Servicios de Membresía](#726-membership-services)
        - 8.2.7 [Mecanismo de Consenso](#727-consensus-mechanism)
            - 8.2.7.1 [Nodos de confianza y validación en IBFT](#7271-trust-and-validator-nodes-in-ibft)
            - 8.2.7.2 [Selección de nodos validadores](#7272-selection-of-validator-nodes)
            - 8.2.7.3 [Número de nodos validadores](#7273-number-of-validator-nodes)
        - 8.2.8 [Distribución de Eventos](#728-event-distribution)
        - 8.2.9 [Servicios Crypto](#729-crypto-services)
        - 8.2.10 [Comunicación entre nodos segura](#7210-secure-inter-node-communication)
    - 8.3 [Capa API](#73-api-layer)
        - 8.3.1 [Interfaces Externas](#731-external-interfaces)
        - 8.3.2 [API de Usuario](#732-user-api)
        - 8.3.3 [API de Administrador](#733-admin-api)
    - 8.4 [Capa de usuario](#74-user-layer)
        - 8.4.1 [Aplicaciones de usuario](#741-user-applications)
        - 8.4.2 [Aplicaciones de administración](#742-administration-applications)
    - 8.5 [Capa de Sistemas No-DLT](#75-non-dlt-systems-layer)
        - 8.5.1 [Oráculo DLT](#751-dlt-oracles)
        - 8.5.2 [Aplicaciones No-DLT](#752-non-dlt-applications)
        - 8.5.3 [Datos Off Ledger](#753-off-ledger-data)
    - 8.6 [Funciones de Capa-Cruzada](#76-cross-layer-functions)
        - 8.6.1 [Desarrollo](#761-development)
            - 8.6.1.1 [IDE (Entorno de Desarrollo Integrado)](#7611-ide-integrated-development-environment)
            - 8.6.1.2 [Gestión de Compilación](#7612-build-management)
            - 8.6.1.3 [Gestión de pruebas](#7613-test-management)
        - 8.6.2 [Gestión y Operaciones](#762-management-and-operations)
            - 8.6.2.1 [Directorio de Servicios](#7621-service-directory)
            - 8.6.2.2 [Gestión de Incidentes](#7622-incident-management)
            - 8.6.2.3 [Gestión de Entrega](#7623-delivery-management)
            - 8.6.2.4 [Gestión de Nodos](#7624-node-management)
            - 8.6.2.5 [Gestión de Ledger](#7625-ledger-management)
            - 8.6.2.6 [Gestión de Sistemas DLT](#7626-dlt-system-management)
            - 8.6.2.7 [Monitoreo](#7627-monitoring)
            - 8.6.2.8 [Gestión de Actualización y Versionamiento](#7628-update-and-version-management)
        - 8.6.3 [Capacidades de Seguridad](#763-security-capabilities)
            - 8.6.3.1 [Gestión de Autenticación e Identidad](#7631-authentication-and-identity-management)
            - 8.6.3.2 [Gestión de políticas de seguridad](#7632-security-policy-management)
            - 8.6.3.3 [Gestión de Acceso](#7633-access-management)
            - 8.6.3.4 [Protección PII](#7634-pii-protection)
        - 8.6.4 [Gobernanza y Cumplimiento](#764-governance-and-compliance)
            ...
            - 8.6.4.4 [Gesti](#7644-policy-management)
...
#### 8.6.1.1. IDE (Integrated Development Environment)
...
### 8.6.2. Management and Operations
...
#### 8.6.2.8. Update and Version Management
...
#### 8.6.3.1. Authentication and Identity Management
...
#### 8.6.3.2. Security Policy Management
...
### 8.6.4. Governance and Compliance
