...
6. [BLOCK2TRACE: A PUBLIC-PERMISSIONED BLOCKCHAIN NETWORK](#5-block2trace--a-public-permissioned-blockchain-network)
7. [GENERAL REQUIREMENTS ABOUT THE SOFTWARE](#6-general-requirements-about-the-software)
    ...
    - 7.3 [Block2Trace should be based on general-purpose and multi-industry platforms](#63-block2trace-should-be-based-on-general-purpose-and-multi-industry-platforms)
    - 7.4 [Block2Trace will allow and facilitate regulatory compliance by the members, in particular:](#64-block2trace-will-allow-and-facilitate-regulatory-compliance-by-the-members--in-particular)
